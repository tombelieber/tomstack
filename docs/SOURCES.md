...
former repositories remain available where they also ship a CLI, hooks,
tracking infrastructure, or an existing public install path.
...
| `impact-aware-qa` | `skills/engineering/impact-aware-qa` | [`tombelieber/impact-aware-qa`](https://github.com/tombelieber/impact-aware-qa) remains an install-compatible historical distribution |
